...
export default class RegistrationForm extends Component {
  ...
  validatePassword() {
    ...
    if (newPassword.length === 0) {
      ...
      return {
        error: true,
        message: "Password must not start or end with empty spacesr",
      };
    ...
    return (
      <form className="Registration__form" onSubmit={this.handleSubmit}>
        <ul className="Form-items">
          ...
          <li>
            {this.state.confirm_password.touched && (
              <ValidateError message={ConfirmPasswordError.message} />
            )}
          </li>
          ...
          <li>
            {this.state.first_name.touched && (
              <ValidateError message={FirstNameError.message} />
            )}
          </li>
          ...
          <li>
            {this.state.last_name.touched && (
              <ValidateError message={LastNameError.message} />
            )}
          </li>
